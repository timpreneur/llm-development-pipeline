...
Every feature dir starts with a `00-manifest.md`. Created by `dev-pipeline-ideate` when the brief lands; updated by every subsequent session as its last action before close.
