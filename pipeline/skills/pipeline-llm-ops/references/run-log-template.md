...
- **`data:interactive-dashboard-builder`** — <diff summary>. Verdict: OK | Review | Block. Affected wrapper(s): `pipeline-ship`. Notes: <…>.
- **`brand-voice:brand-voice-enforcement`** — <diff summary>. Verdict: Review. Affected wrapper(s): `pipeline-ship`. Notes: <…>.
...
- pipeline-substrate: <N> entries, <U> un-reconciled
- pipeline-ideate: <N> entries, <U> un-reconciled
- pipeline-plan: <N> entries, <U> un-reconciled
- pipeline-build: <N> entries, <U> un-reconciled
- pipeline-ship: <N> entries, <U> un-reconciled
- pipeline-research: <N> entries, <U> un-reconciled
- pipeline-llm-ops: <N> entries, <U> un-reconciled
